...
class TestCheckpointCreation:
    ...
    def test_checkpoint_has_required_fields(self, tmp_path):
        ...
        required_fields = ["run_id", "pipeline_version", "started_at", "last_updated", "status", "stages", "config"]
...
class TestCheckpointLoading:
    ...
    def test_missing_checkpoint_without_resume(self, tmp_path):
        ...
        orch = PipelineOrchestrator(checkpoint_file=str(checkpoint_path), resume=False)
...
class TestResumeLogic:
    ...
    def test_skip_completed_stages_on_resume(self, tmp_path):
        ...
        checkpoint_data = {
            ...
            "last_updated": "2025-11-11T14:35:00",
            "status": "in_progress",
            "stages": {"journal_reviewer": {"status": "completed"}, "judge": {"status": "in_progress"}},
            "config": {},
        }
        with open(checkpoint_path, "w") as f:
            json.dump(checkpoint_data, f)
    ...
    def test_invalid_stage_name_in_resume_from(self, tmp_path):
        ...
        orch = PipelineOrchestrator(checkpoint_file=str(checkpoint_path), resume=True, resume_from="invalid_stage")
...
class TestIntegrationWithRunStage:
    ...
    def test_run_stage_skip_completed(self, mock_subprocess, tmp_path):
        ...
        checkpoint_data = {
            ...
            "last_updated": "2025-11-11T14:35:00",
            "status": "in_progress",
            "stages": {"test_stage": {"status": "completed", "exit_code": 0}},
            "config": {},
        }
        with open(checkpoint_path, "w") as f:
            json.dump(checkpoint_data, f)
...
class TestSecurityAndSafety:
    ...
    def test_checkpoint_no_sensitive_data(self, tmp_path):
        ...
        config = {"api_key": "secret_key_12345", "password": "my_password", "stage_timeout": 3600}
